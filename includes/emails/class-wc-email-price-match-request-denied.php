...
class WC_Email_Price_Match_Request_Denied extends WC_Email {

	public function __construct() {

		// set ID
		$this->id = 'wc_price_match_request_denied';

		// this is the title in WooCommerce Email settings
		$this->title = 'Price Match Request Denied';

		// this is the description in WooCommerce email settings
		$this->description = 'Sent to the customer when their price match request is denied.';

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = 'Price Match Request Denied';
		$this->subject = 'Your price match request was denied';

		// Trigger on price match request approval
		add_action( 'hmwcpm_request_denied', array( $this, 'trigger' ) );
	...
	public function get_content_plain() {
		...
		echo('Your price match request for "'.get_the_title($product_id).'" was denied.
		
			To purchase the product at the regular price, please visit the URL below:
			'.$link);
